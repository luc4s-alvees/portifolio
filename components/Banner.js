          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Lucas`}</h1><h1 className="profissao"> 
                  <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer"]'>
                    <span className="wrap">{text}</span>
                  </span>
                </h1>
                <p>My name is Lucas Alves Rocha, I'm 21 years old, I'm a Technologist in Systems Analysis and Development, MBA Fullstack development. </p>
                  <button onClick={() => window.location='#connect'}>Let’s Connect <ArrowRightCircle size={25} /></button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5} className="bannerMobile" >
            <TrackVisibility>
              {({ isVisible }) =>
                // <div className={isVisible ? "animate__animated animate__zoomIn" : ""}>
                <div className="fundoImg">

                <div className={isVisible ? "bannerImg" : ""}>
